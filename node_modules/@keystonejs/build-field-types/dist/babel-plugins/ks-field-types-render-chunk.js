  ...
  return {
    visitor: {
      CallExpression(path, state) {
        ...
        let relativePath = nodePath.relative(nodePath.dirname(nodePath.join(pkgDir, filename)), chunkPath);
        path.replaceWith(t.callExpression(pathJoinIdentifier, [t.identifier('__dirname'), t.stringLiteral(relativePath)]));
        return;
      }
