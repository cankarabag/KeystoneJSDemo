...
var HistoryPopup = /** @class */function (_super) {
    ...
    HistoryPopup.prototype.render = function () {
        ...
        return React.createElement(
            Modal,
            { isOpen: this.props.isOpen, onRequestClose: this.props.closeHistory, contentLabel: "GraphiQL Session History", style: constants_1.modalStyle },
            React.createElement(
                Wrapper,
                null,
                React.createElement(
                    ...
                    React.createElement(HistoryItems_1.default, { items: items, selectedItemIndex: this.state.selectedItemIndex, searchTerm: this.state.searchTerm, onItemSelect: this.handleItemSelect, onItemStarToggled: this.props.toggleHistoryItemStarring })
                ),
                Boolean(selectedItem) ? React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(Icons_1.ArrowRight, { color: "white", width: 13, height: 13 })
                        )
                    ),
                    React.createElement(
                        Big,
