...
exports.default = styled_1.withTheme(function (_a) {
    ...
    return React.createElement(
        ...
        items.map(function (item, index) {
            return React.createElement(
                HistoryItem,
                { key: item.id, active: selectedItemIndex === index, onClick: function onClick() {
                        return onItemSelect(index);
                    } },
                React.createElement(
                    OperationSide,
                    null,
                    React.createElement(Icons_1.Star, { onClick: function onClick() {
                            return onItemStarToggled(item.id);
                        }, stroke: !item.starred ? 'rgb(221,171,0)' : undefined, fill: item.starred ? 'rgb(221,171,0)' : undefined, strokeWidth: 0.5, width: 25, height: 25 }),
                    React.createElement(
                        Operation,
                        null,
                        React.createElement(
                ...
                React.createElement(
                    ...
                    item.date && React.createElement(
                        Time,
                        null,
                        typeof item.date.getMonth === 'function' && item.date.getMonth() + 1,
                        "/",
                        item.date.getDate(),
                        "/",
