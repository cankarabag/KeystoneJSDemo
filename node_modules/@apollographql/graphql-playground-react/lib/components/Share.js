                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(ToggleButton_1.default, { checked: allTabs, onChange: this.props.toggleShareAllTabs })
                            ),
                            React.createElement(
                                Row,
                                null,
                                ...
                                React.createElement(ToggleButton_1.default, { checked: headers, onChange: this.props.toggleShareHeaders })
                            ),
                            React.createElement(
                                Row,
                                null,
                                ...
                                React.createElement(ToggleButton_1.default, { checked: history, onChange: this.props.toggleShareHistory })
                            ),
                            shareUrl && React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        Copy_1.default,
                                        { text: shareUrl },
                                        React.createElement(Icons_1.ShareIcon, { color: theme.colours.darkBlue30, width: 25, height: 25, title: "Copy URL to Clipboard" })
                                    )
                                )
                            ),
                            React.createElement(
                                ...
                                React.createElement(
                                    Button_1.Button,
                                    { hideArrow: true, onClick: this.share },
