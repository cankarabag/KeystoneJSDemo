            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        Logo,
                        null,
                        React.createElement("img", { src: require('../assets/logo.png'), alt: "" }),
                        React.createElement(
                            Heading,
                            null,
                            "GraphQL Playground"
                ...
                React.createElement(
                    ...
                    React.createElement(Input, { type: "text", placeholder: "Enter an endpoint url...", value: this.state.endpoint, onChange: this.onChangeEndpoint, valid: typeof valid === 'boolean' && valid, invalid: typeof valid === 'boolean' && !valid, autoFocus: true }),
                    valid && React.createElement(
                        Button_1.Button,
                        { purple: true, onClick: this.close },
                        "Use Endpoint"
                    )
                )
            )
