...
var PlaygroundWrapper = /** @class */ (function (_super) {
    ...
    PlaygroundWrapper.prototype.render = function () {
        ...
        return (<div>
        {title}
        <styled_1.ThemeProvider theme={__assign({}, styled_1.theme, { mode: theme, colours: theme === 'dark' ? theme_1.darkColours : theme_1.lightColours, editorColours: __assign({}, (theme === 'dark' ? theme_1.darkEditorColours : theme_1.lightEditorColours), this.props.codeTheme), settings: this.props.settings })}>
          <App>
            {this.props.config &&
