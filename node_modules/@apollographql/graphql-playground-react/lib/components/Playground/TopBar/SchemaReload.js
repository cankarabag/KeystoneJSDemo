...
var SchemaReload = function SchemaReload(props) {
    if (props.isPollingSchema) {
        return React.createElement(Polling_1.default, { interval: props.settings['schema.polling.interval'], onReloadSchema: props.onReloadSchema });
    }
    return React.createElement(Reload_1.default, { isReloadingSchema: props.isReloadingSchema, onReloadSchema: props.onReloadSchema });
};
