...
var ExecuteButtonOperation = /** @class */function (_super) {
    ...
    ExecuteButtonOperation.prototype.render = function () {
        return React.createElement(
            "li",
            { key: this.props.operation.name ? this.props.operation.name.value : '*', className: this.props.operation === this.props.highlight ? 'selected' : '', onMouseOver: this.onMouseOver, onMouseOut: this.props.onMouseOut, onMouseUp: this.onMouseUp },
