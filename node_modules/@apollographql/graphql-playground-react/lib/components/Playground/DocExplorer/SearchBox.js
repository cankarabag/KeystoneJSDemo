...
var SearchBox = /** @class */function (_super) {
    ...
    SearchBox.prototype.render = function () {
        var LabelComponent = React.createElement(
            Label,
            null,
            React.createElement(Icons_1.Search, { height: 16, width: 16, strokeWidth: 3, color: 'rgba(0, 0, 0, 0.3)' }),
            React.createElement(Input, { onChange: this.handleChange, type: "text", value: this.state.value, placeholder: this.props.placeholder || 'Search the docs ...' })
        );
        if (this.props.clean) {
