    ...
    FieldDoc.prototype.render = function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                DocsHeader,
                null,
                React.createElement(TypeLink_1.default, { type: field, x: level, y: -1, clickable: false, lastActive: false })
            ),
            React.createElement(DocsDescription, { className: "doc-type-description", markdown: field.description || '' }),
            React.createElement(
            ...
            type instanceof graphql_1.GraphQLUnionType && React.createElement(UnionTypeSchema_1.default, { type: type, schema: schema, level: level, sessionId: this.props.sessionId }),
            obj.fields && obj.fields.length > 0 && React.createElement(DocTypeSchema_1.default, { type: type, fields: obj.fields, interfaces: obj.interfaces, level: level, sessionId: this.props.sessionId }),
            obj.args && obj.args.length > 0 && React.createElement(
                "div",
                null,
                React.createElement(
                    DocsStyles_1.CategoryTitle,
            ...
            obj.implementations && obj.implementations.length > 0 && React.createElement(
                "div",
                null,
                React.createElement(
                    DocsStyles_1.CategoryTitle,
                ...
                obj.implementations.map(function (data, index) {
                    return React.createElement(TypeLink_1.default, { key: data.name, type: data, x: level, y: index + implementationsOffset, collapsable: true, lastActive: false });
                })
            )
        );
    };
