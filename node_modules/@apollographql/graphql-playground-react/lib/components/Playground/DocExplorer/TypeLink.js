...
var TypeLink = /** @class */function (_super) {
    ...
    TypeLink.prototype.render = function () {
        ...
        return React.createElement(
            DocsCategoryItem,
            { active: isActive, clickable: clickable, className: "doc-category-item" + (className ? className : ''), onClick: this.onClick, ref: this.setRef },
            beforeNode,
            beforeNode && ' ',
            ...
            clickable && React.createElement(
                IconBox,
                null,
                React.createElement(Icons_1.Triangle, null)
            ),
            afterNode && ' ',
            afterNode
        );
