...
window['GraphQLPlayground'] = {
    init: function init(element, options) {
        ReactDOM.render(React.createElement(MiddlewareApp_1.default, _extends({ setTitle: true, showNewWorkspace: false }, options, {
            // config={config}
            // configString={configString}
            // codeTheme={lightEditorColours}
            // tabs={tabs}
            createApolloLink: customLinkCreator })), element);
    }
};
